...
-   **02_Environment_Wrack_Analyses.R** conducts all analyses for investigating the best environmental predictors of wrack biomass. This script also generates Figure S4.
...
-   Folder [**extra_figures**](https://github.com/fgerraty/Fucus_Wrack/tree/main/output/extra_figures) containing R outputs for figures combined using Adobe Illustrator into multi–panel figures.
    ...
    -   wrack_invert_biomass.png - output from **03_Wrack_Invert_Analyses.R** script, edited in Illustrator to make Figure 3.
