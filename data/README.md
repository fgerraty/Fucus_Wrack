...
To replicate the map in Figure 1, you need to manually add the "Alaska Coastline" shapefile into a subfolder called "alaska_shapefile" in the [***data/raw/***](https://github.com/fgerraty/Fucus_Wrack/tree/main/data/raw) folder. The shapefile is published by the State of Alaska and is publicly accessible here (as of 11 December, 2024). This must be done manually because this file is too large to push to GitHub: <https://gis.data.alaska.gov/maps/24bb1a5332894893bf9a305d9f6c6696>
